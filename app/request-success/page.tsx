    ...
    return (
        <>
            <main className="flex flex-col items-center gap-[16vw] pt-[8.5vw] pb-[5.83vw] bg-light relative max-xs:pb-[10vw]">
                <Image src={"/request-success-statue.png"} alt="statue" width={400} height={400} className="w-[18%] absolute top-[9%] left-[3%] z-[1] max-xs:bottom-[4%] max-xs:top-auto" />
                <Image src={"/request-success-statue.png"} alt="statue mirrored" width={400} height={400} className="w-[18%] absolute top-[9%] right-[3%] scale-x-[-1] z-[1] max-xs:bottom-[4%] max-xs:top-auto" />
                ...
                <p className="font-iowan text-brown font-bold text-[3.19vw] max-w-[40%] text-center max-xs:max-w-[33%] max-xs:text-[4vw]">Очаквайте потвърждение на поръчката до 2 работни дни!</p>
            </main>
        </>
    );
}
